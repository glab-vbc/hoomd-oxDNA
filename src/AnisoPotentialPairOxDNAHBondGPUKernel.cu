...
gpu_compute_pair_aniso_forces<EvaluatorPairOxDNAHBond>(
    const a_pair_args_t& pair_args,
    const EvaluatorPairOxDNAHBond::param_type* d_param,
    const EvaluatorPairOxDNAHBond::shape_type* d_shape_param);
